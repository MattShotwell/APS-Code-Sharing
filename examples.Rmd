...
data_sofa_imp <- data_sofa %>%
  ...
  mutate(sofa_missing_reason = case_when(
    study_date < ds_arrival_date ~ "Pre-hospital",
    !is.na(dthdat) & study_date > dthdat ~ "Deceased",
    !is.na(disdat) & study_date > disdat ~ "Discharged",
    !is.na(dsstdat) & study_date > dsstdat &
      grepl('No further|Withdrawn|Lost', dsdecod) ~ dsdecod,
