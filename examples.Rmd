...
2. For each component score, the earliest missing score among study days -2, -1, or 0 is assigned a value of 0 (normal), consistent with footnote b in re at day 0 cannot be imputed using LOCF (because there are no values to carry forward from days -2 or -1), then those components will be scored as 0 (no organ dysfunction; see footnote b in [Ranzani et al; 2025](https://jamanetwork.com/journals/jama/fullarticle/2840822)).
